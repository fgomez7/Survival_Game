...
- Craftable items include:  
  - **Stick** – Requires 2 Wood  
  - **Box** – Requires 4 Wood and 3 Sticks  
  - **Sword** – Requires 2 Stone and 4 Wood  
  - **Axe** – Requires 2 Stone and 3 Wood  
  - **Stone Box** – Requires 3 Stone  
- Crafting removes required materials and spawns the crafted item near the player  
- Craft buttons automatically disable if you lack resources  
